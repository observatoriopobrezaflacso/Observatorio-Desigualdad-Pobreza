...
local sal_min 85.65 121.91 150 354
*local sal_min 394
...
use "$procesado/ingresos_pc/ing_perca_`y'_nac_precios2000.dta", clear
	...
	* Horas efectivas: persona con empleo y trabajando
	...
	if `y' >= 2007 replace horas = p24 if pean == 1 & p20 == 2 & p21 <= 11
	else           replace horas = p24 if pean == 1 & p20 == 2 & p21 <= 10
	...
	* Horas habituales: persona con empleo y sin trabajar
	...
	if `y' >= 2007 replace horas = hh if pean == 1 & p20 == 2 & p21 == 12 & p22 == 1
	else      replace horas = hh if pean == 1 & p20 == 2 & p21 == 11 & p22 == 1
	...
	*==============================================================================*
	...
	if `y' == 2015 replace d_d = 0 if empleo == 1 & (p25 == 9 | p27 == 4)
	else           replace d_d = 0 if empleo == 1 &  p27 == 2
	if `y' == 2015 replace d_d = 1 if empleo == 1 & p27 <= 3 & p28 == 1
