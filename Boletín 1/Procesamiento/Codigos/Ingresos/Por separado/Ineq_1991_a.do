...
cd "G:/Mi unidad/Procesamiento/Bases/ENEMDU - copia"

use "1991/12/empleo91.dta", clear
...
ineqdeco ing_lab [w=fexp]
ineqdeco ing_rent [w=fexp]


povdeco ingtot_per [w=fexp], pline(29157.0)
