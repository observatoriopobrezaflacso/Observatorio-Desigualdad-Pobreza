 ...
 use "C:\Users\JuanElíasPonceJarrín\OneDrive - flacso.edu.ec\Documents\DISCO D\BASES DE DATOS DEMOGRAFICAS INEC\ENCUENTAS DE EMPLEO\Encuestas de empleo\bddenemdu_personas_2021_anual.dta", clear
...
gen horas=p24*4
gen ingl_horas=ingrl/horas

tabstat ingrl [w=round(fexp)], by(duniversitario) statistics (N mean)
tabstat ingl_horas [w=round(fexp)], by(duniversitario) statistics (N mean)
