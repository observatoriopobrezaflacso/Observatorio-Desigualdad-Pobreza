...
clear all
set more off
use "D:\DTO_ESTUDIOS_E1\B_INVESTIGADORES_EXTERNOS\2025.12.01_Ruthy Intriago\03 BDD\Anexo RDEP\F107_anonimizada_2010.dta" 

drop numero_retenciones anio_retencion estado anio tipo_empleador ente_seguirdad_social numero_meses_trab_empleador establecimiento residencia pais_residencia conv_doble_imp_pago porcen_discapa_trabaj cod_tipo_id_discapacitado trabajador_discapacitado codigo_tipo_identificacion
...
* Nota: Se realiza construyendo un valor teórico que es la suma de los ingresos 
*       liquidos pagados, sobre sueldos y participacion de utilidades por 8.33%. 
...
*6. Corrección de fondos de reserva
	...
	* Si el fondo de reserva real es positivo y menor a missing, y además el coeficiente 
	* excede el 8,33%, se reemplaza por el valor teórico.
...
save Form_107_work_2010, replace
