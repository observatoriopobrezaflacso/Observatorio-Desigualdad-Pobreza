...
NOTA_TITULO = (
    ...
    "2003-2006 y las de pobreza laboral, (3) eliminaron el 2001 del análisis por "
    "razones explicadas en la nota del gráfico 1 y (4) extendieron el análisis de "
    "la desagregación por etnia a 2025."
)
