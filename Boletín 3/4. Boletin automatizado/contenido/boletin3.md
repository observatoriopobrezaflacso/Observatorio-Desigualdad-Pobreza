...
La desagregación por etnia ({{G.etnia}}) muestra que los indígenas son el grupo con mayor informalidad laboral, alcanzando el {{inf_etnia[-1,'Indígena']}}% de la población ocupada en {{ultimo}}, nivel similar al de inicio del siglo. En el año con menor informalidad ({{anio_minimo(inf_etnia, grupo='Indígena')}}), llegó al {{minimo(inf_etnia, grupo='Indígena')}}%. Muy por detrás se ubican las personas afroecuatorianas ({{inf_etnia[-1,'Negro/Afro']}}%) y las blancas/mestizas ({{inf_etnia[-1,'Blanco/Mestizo']}}%), con niveles prácticamente iguales entre sí en {{ultimo}}. La diferencia entre indígenas y blancos/mestizos es de {{inf_etnia[-1,'Indígena'] - inf_etnia[-1,'Blanco/Mestizo']}} puntos porcentuales.
