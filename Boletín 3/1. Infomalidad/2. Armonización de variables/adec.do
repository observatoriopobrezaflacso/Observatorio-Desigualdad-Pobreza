...
global important_variable adec
...
*	use "$procesado/ing_perca_`y'_urb_precios2000.dta", clear
...
save "$out/historico_adec.dta", replace


use "$out/historico_adec.dta", clear
